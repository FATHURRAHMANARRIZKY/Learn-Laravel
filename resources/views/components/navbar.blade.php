        ...
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="hidden md:flex justify-center flex-1">
                <div class="flex items-baseline space-x-4">
                    ...
                    <x-nav-link href="/" :active="request()->is('reviews')">Reviews</x-nav-link>
            ...
            <div class="hidden md:block">
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <div class="relative ml-3">
                        <button @click="isOpen = !isOpen" id="user-menu-button" type="button" aria-expanded="false"
                            aria-haspopup="true"
            ...
            <div class="-mr-2 flex md:hidden">
                <!-- Mobile menu button -->
                <button @click="isOpen = !isOpen" type="button" aria-controls="mobile-menu" aria-expanded="false"
