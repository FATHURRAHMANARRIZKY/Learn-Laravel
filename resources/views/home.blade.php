<x-layout>
    <x-slot:title>{{ $title }}</x-slot:title>
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-4 lg:px-0 ">
            ...
            <div>By <a href="/authors/{{ $post->author->username }}" class="hover:underline text-base
            ...
            <a href="/{{ $post['slug'] }}" class="font-medium text-blue-500 hover:underline">read more &raquo;</a>
        </article> --}}
